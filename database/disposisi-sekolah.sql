...
\restrict F2UGZrkzqX0Sz26hbjX3yDzmN73AfebdbASg2tSPz6mjriNUALLt7NB3QiT846P
...
--
-- Name: set_dibaca_disposisi_penerima(); Type: FUNCTION; Schema: public; Owner: rpl1
--
...
ALTER FUNCTION public.set_dibaca_disposisi_penerima() OWNER TO rpl1;
...
--
-- Name: distribusi_sm; Type: TABLE; Schema: public; Owner: rpl1
--
...
CREATE TABLE public.distribusi_sm (
    ...
    CONSTRAINT disposisi_penerima_status_check CHECK (((status)::text = ANY (ARRAY[('belum_dibaca'::character varying)::text, ('dibaca'::character varying)::text, ('sedang_dikerjakan'::character varying)::text, ('selesai'::character varying)::text])))
);


ALTER TABLE public.distribusi_sm OWNER TO rpl1;

--
-- Name: disposisi_penerima_id_penerima_disposisi_seq; Type: SEQUENCE; Schema: public; Owner: rpl1
--
...
ALTER SEQUENCE public.disposisi_penerima_id_penerima_disposisi_seq OWNER TO rpl1;

--
-- Name: disposisi_penerima_id_penerima_disposisi_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: rpl1
--
...
--
-- Name: distribusi_sm id_penerima_disposisi; Type: DEFAULT; Schema: public; Owner: rpl1
--
...
--
-- Data for Name: distribusi_sm; Type: TABLE DATA; Schema: public; Owner: rpl1
--

COPY public.distribusi_sm (id_penerima_disposisi, id_disposisi, id_user, id_jabatan, read_at, created_at, status) FROM stdin;
\.
...
--
-- Name: disposisi_penerima_id_penerima_disposisi_seq; Type: SEQUENCE SET; Schema: public; Owner: rpl1
--
...
--
-- Name: distribusi_sm disposisi_penerima_pkey; Type: CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: distribusi_sm uq_disposisi_penerima; Type: CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: distribusi_sm disposisi_penerima_disposisi_fkey; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: distribusi_sm disposisi_penerima_jabatan_fkey; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: distribusi_sm disposisi_penerima_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
...
\unrestrict F2UGZrkzqX0Sz26hbjX3yDzmN73AfebdbASg2tSPz6mjriNUALLt7NB3QiT846P
